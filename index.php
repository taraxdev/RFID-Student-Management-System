...
<div class="login-box">
    ...
    <!-- <div class="login-logos">
  	...
  	<div class="login-box-body">
    	<h4 class="login-box-msg" style="font-weight: bold; color: #3D6245; font-size: 20px;">ATTENDANCE SYSTEM</h4>
    	...
    	<form id="attendance">
          ...
          <div class="row" id="hideValueOnSelect">
            <div class="form-group col-sm-8">
                  <input type="text" class="form-control input-lg" id="temperature" autocomplete="off" name="temperature" placeholder="">
              </div>
              <div class="form-group col-sm-4">
                  <input type="text" class="form-control input-lg" id="tagno" autocomplete="off" name="tagno" placeholder="">
              </div>
          </div>
      		<div class="row">
    			<div class="col-sm-4">
